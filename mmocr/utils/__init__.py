...
from .polygon_utils import (crop_polygon, poly2bbox, rescale_polygon,
                            rescale_polygons)
...
__all__ = [
    ...
    'dump_ocr_data', 'rescale_polygons', 'rescale_polygon', 'poly2bbox',
    'recog_anno_to_imginfo', 'bbox2poly', 'crop_polygon', 'rescale_bboxes'
]
