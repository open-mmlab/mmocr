...
class TPSPreprocessor(BasePreprocessor):
    ...
    def __init__(self, num_fiducial, I_size, I_r_size, I_channel_num=1):
        ...
        self.LocalizationNetwork = LocalizationNetwork(self.num_fiducial,
                                                       self.I_channel_num)
        self.GridGenerator = GridGenerator(self.num_fiducial, self.I_r_size)
...
class LocalizationNetwork(nn.Module):
    """Localization Network of RARE, which predicts C' (K x 2) from I (I_width
    x I_height)"""
...
class GridGenerator(nn.Module):
    ...
    def __init__(self, num_fiducial, I_r_size):
