...
class SegDetector(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            inner_channels (int): Number of input channels.
            k (int | float): Amplifying factor in the step function.
            bias (bool): Whether conv layers have bias or not.
            adaptive (bool): Whether to use adaptive threshold training or not.
            smooth (bool): If true, use bilinear instead of deconv.
            serial (bool): If true, thresh prediction will combine with
                segmentation result as input.
        '''
