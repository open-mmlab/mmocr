...
from mmocr.apis.inferencers import TextSpotInferencer
from mmocr.utils.check_argument import is_type_list


class TestTextSpotInferencer(TestCase):

    # TODO: replace it with a real e2e model

    def setUp(self):
        # init from alias
        self.inferencer = TextSpotInferencer('DB_r18')

    def test_init(self):
        # init from metafile
        TextSpotInferencer('dbnet_resnet18_fpnc_1200e_icdar2015')
        # init from cfg
        TextSpotInferencer(
    ...
    def test_postprocess(self):
        ...
        self.assertTrue(is_type_list(res['predictions'], TextSpotInferencer))
